...
def virtual_potential_temperature(theta, r, rl):
    """
...
def saturation_vapor_pressure(temp): # To be checked
    """
...
def actual_vapor_pressure_from_saturation(es): # To be checked
...
def mixing_ratio_from_actual_vapor_pressure(press, e): # To be checked
    """
...
def liquid_water_mixing_ratio(press, r): # To be checked
    """
...
def virtual_potential_temperature_from_temp_rh_press(temp, rh, press):
    """
    ...
    e = actual_vapor_pressure_from_saturation(es)
    r = mixing_ratio_from_actual_vapor_pressure(press, e)
    rl = liquid_water_mixing_ratio(press, r)
    theta = potential_temperature(temp, press)
    theta_v = virtual_potential_temperature(theta, r, rl)
    return theta_v