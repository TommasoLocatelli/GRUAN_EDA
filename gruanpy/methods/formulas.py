...
def potential_temperature(T, p, p0=1000.0):
    ...
    """
    theta = T * (p0 / p) ** (R_DRY_AIR / C_P_DRY_AIR)
    return theta
...
def bulk_richardson_number(avg_Tv, delta_virtual_pot_temp, delta_z, delta_wspeed, g=G0):
