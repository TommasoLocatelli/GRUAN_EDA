...
for file_path in file_paths[:5]:
    ...
    upper_bound=gp._find_upper_bound(gdp.data[['alt']], upper_bound=5000, retnrn_value=True) # find the PBLG upper bound for profile
    ...
    if pblh_pm is not None: # plot PBLH line
        ax1.axhline(pblh_pm, color=map_labels_to_colors['pblh_pm'], linestyle=':', linewidth=2, label=f'Parcel PBLH: {pblh_pm:.1f} m')
