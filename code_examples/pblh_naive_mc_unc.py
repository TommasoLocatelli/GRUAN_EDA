...
Noisy profiles are generated by adding random noise to the original measurements based on their uncertainties.
Smoothed noise is used to preserve correlation in the noise.
"""
import sys
import os
